...
public class Register extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://chatapp-b32dd-default-rtdb.firebaseio.com/");
